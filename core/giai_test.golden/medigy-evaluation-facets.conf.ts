...
export const evalFacetsHome = guessPath("giai_test.golden");

export const qualityCampaign = new TypicalCampaign(
  "Quality",
  evalFacetsHome.childPath("Quality"),
  (campaign) => {
...
export const securityCampaign = new TypicalCampaign(
  "Security",
  evalFacetsHome.childPath("Security"),
  (campaign) => {
    campaign.questionnaires.push(
      new TypicalCampaignQuestionnaire(
        campaign,
...
export const interopCampaign = new TypicalCampaign(
  "Interoperability",
  evalFacetsHome.childPath("Interoperability"),
  (campaign) => {
    campaign.questionnaires.push(
      new TypicalCampaignQuestionnaire(
        campaign,
...
export const ethicsCampaign = new TypicalCampaign(
  "Ethics and Compliance",
  evalFacetsHome.childPath("Ethics-and-Compliance"),
  (campaign) => {
    campaign.questionnaires.push(
      new TypicalCampaignQuestionnaire(
        campaign,
...
export const expectationsCampaign = new TypicalCampaign(
  "Expectations",
  evalFacetsHome.childPath("Expectations"),
  (campaign) => {
    campaign.questionnaires.push(
      new TypicalCampaignQuestionnaire(
        campaign,
        ...
        ),
        {
          ...
          shareInfo: "Would you like to share your OKRs for <offering_name>",
          invitationInfo:
...
export const uxCampaign = new TypicalCampaign(
  "User Experience",
  evalFacetsHome.childPath("User-Experience"),
  (campaign) => {
    campaign.questionnaires.push(
      new TypicalCampaignQuestionnaire(
        campaign,
...
export const iaCampaign = new TypicalCampaign(
  "Information Assurance",
  evalFacetsHome.childPath("Information-Assurance"),
  (campaign) => {
    campaign.questionnaires.push(
      new TypicalCampaignQuestionnaire(
        campaign,
...
export const config: InfoAcqConfiguration = {
  isInfoAcqConfiguration: true,
  campaigns: [
    qualityCampaign,
    securityCampaign,
    interopCampaign,
    ethicsCampaign,
    expectationsCampaign,
    uxCampaign,
    iaCampaign,
  ],
};
